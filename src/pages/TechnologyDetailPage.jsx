...
const TechnologyDetailPage = ({ onOpenAppointment }) => {
  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-16 space-y-10">
      ...
      <PageHero
        title={tech.name}
        subtitle={`${tech.category} • Advanced Surgical & Diagnostic Orthopedic Suite`}
        breadcrumb={[
          { label: 'Robotic & Tech', path: '/technologies' },
          { label: tech.name }
        ]}
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-md space-y-4">
            <div className="inline-block px-3 py-1 bg-blue-50 text-blue-800 text-xs font-bold rounded-lg uppercase tracking-wider border border-blue-100">
              {tech.category}
            </div>
            ...
            <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
              ...
              >
                ...
                <span>Book Consultation for {tech.name.split(' ')[0]}</span>
              </button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 shadow-md space-y-4">
            <h3 className="text-base font-bold text-slate-950 border-b border-slate-100 pb-3 flex items-center space-x-2 font-heading">
              ...
              <span>Surgical Precision & Patient Benefits</span>
            </h3>
