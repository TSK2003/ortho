...
const sidebarLinks = [
  { to: '/admin/dashboard', label: 'Hospital ERP Dashboard', icon: LayoutDashboard },
  { to: '/admin/beds', label: 'Robotic ICU & Ortho Wards', icon: BedDouble },
  { to: '/admin/staff', label: 'Surgeons & OT Workforce', icon: Users },
  { to: '/admin/appointments', label: 'OPD Tokens & Surgery Queue', icon: CalendarCheck },
  { to: '/admin/doctors', label: 'Orthopedic Surgeons Directory', icon: UserRound },
  { to: '/admin/departments', label: 'Surgeries & Specialties', icon: Layers3 },
  { to: '/admin/branches', label: 'Hospitals & Joint Clinics', icon: MapPin },
  { to: '/admin/technologies', label: 'Robotic Suites & Equipment', icon: Cpu },
  { to: '/admin/blog', label: 'Orthopedic Patient Guides', icon: FileText },
  { to: '/admin/hospital-info', label: 'Hospital Profile & Helpline', icon: Building2 },
          ...
          <div className="p-4 border-b border-slate-800">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2.5">
                ...
                <div>
                  <p className="text-sm font-black text-white tracking-wide uppercase font-heading">{hospitalInfo.name || 'ORTHOCARE'}</p>
                  <p className="text-[10px] text-blue-400 font-bold uppercase tracking-wider">Hospital ERP Admin</p>
                </div>
              </div>
              <button
          ...
          <div className="px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-sm font-bold text-slate-800 hidden sm:block">
                Orthopedic Hospital Management & Clinical ERP System
              </h1>
            </div>
            ...
            <div className="flex items-center space-x-3 text-xs">
              <span className="inline-flex items-center px-2.5 py-1 rounded-full text-[11px] font-bold bg-emerald-50 text-emerald-800 border border-emerald-200">
                ...
                Surgical System Online
              </span>
              <div className="hidden sm:block text-right">
                <p className="font-bold text-slate-900">Dr. Administrator</p>
                <p className="text-[10px] text-slate-500">Chief Surgical Officer</p>
              </div>
            </div>
          </div>
        </header>
