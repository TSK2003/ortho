...
const GalleryPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-16 space-y-10">
      <PageHero
        title="Orthopedic Operating Suites & Hospital Gallery"
        subtitle="Explore our Stryker Mako robotic joint suites, Class-100 laminar airflow OTs, DEXA bone density labs, and inpatient recovery units."
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {images.map((img, idx) => (
            <div key={idx} className="bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-200 group hover:shadow-xl transition-all">
              ...
              <div className="p-5">
                <span className="text-[10px] font-bold uppercase text-blue-700 bg-blue-50 px-2.5 py-0.5 rounded-md">{img.category}</span>
